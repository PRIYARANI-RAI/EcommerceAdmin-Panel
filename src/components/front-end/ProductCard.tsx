import { addToCart } from "@/redux/feactures/cartSlice";
    ...
    <div className="border border-gray-200">
        ...
        <div className="px-8 py-4">
            ...
            <div className="flex justify-between items-center mt-4">
                ...
                <div className="flex gap-2 items-center bg-pink-400 text-white px-4 py-2 cursor-pointer hover:bg-blue-500" onClick={addProductToCart}>
